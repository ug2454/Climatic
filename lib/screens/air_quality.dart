...
class _AirQualityScreenState extends State<AirQualityScreen>
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: SafeArea(
              child: buildAirQualityDetailsColumn(),
            ),
          ),
        ),
      ),
  ...
  Column buildAirQualityDetailsColumn() {
    return Column(
    ...
    return SfRadialGauge(
      ...
      axes: <RadialAxis>[
        RadialAxis(
          ...
          pointers: <GaugePointer>[NeedlePointer(value: aqi.toDouble())],
          annotations: <GaugeAnnotation>[
            GaugeAnnotation(angle: aqi.toDouble(), positionFactor: 0.5)
          ],
        ),
      ],
    );
  ...
  InputDecoration buildWeatherInputDecoration() {
